...
crossing_count = 0
trackers = []  # List to keep track of multiple trackers
tracked_objects = set()
...
while processed_count < max_frames:
    ...
    # Update trackers and get updated bounding boxes
    ...
    for result in results:
        for box in result.boxes:
            ...
            # Add new tracker for the object
